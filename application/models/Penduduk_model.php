...
class Penduduk_model extends CI_Model
{
    ...
    public function getById($pndk_id){
        ...
        sts_pernikahan.stspnkn_ket as sts_pernikahan, kewarganegaraan.kwgn_ket as kewarganegaraan, jns_asuransi.jnsasn_ket as jns_asuransi');
        ...
        $this->db->join('kewarganegaraan', 'penduduk.kwgn_id = kewarganegaraan.kwgn_id');

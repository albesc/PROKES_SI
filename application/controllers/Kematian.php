...
class Kematian extends CI_Controller
{
    ...
    function index()
    {
        $jumlah_data = $this->Kematian_model->tkematian();
        $config["base_url"] = base_url() . "Kematian/index";
        ...
        $data['kematian'] = $this->Kematian_model->get($config['per_page'], $from);
    ...
    public function upload()
    {
        $data = [
            ...
            'kmtn_yg_menerangkan' => $this->input->post('kmtn_yg_menerangkan'),

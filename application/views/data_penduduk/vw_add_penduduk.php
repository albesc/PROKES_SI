                     ...
                     <div class="card-header border-0">
                         <form>
                             ...
                             <div class="row">
                                 <div class="col-4">
                                     <div class="form-group">
                                         <label for="example-tel-input" class="form-control-label">Nama Penduduk</label>
                                         <input class="form-control" type="text" id="example-text-input">
                                     </div>
                                 </div>
                                 <div class="col-3">
                             ...
                             <div class="row">
                                 <div class="col-3">
                                     <div class="form-group">
                                         <label for="example-password-input" class="form-control-label">Tempat Lahir</label>
                                         <input class="form-control" type="text" id="example-text-input">
                                     </div>
                                 </div>
                                 <div class="col-3">
                             ...
                             <div class="row">
                                 <div class="col-2">
                                     <div class="form-group">
                                         <label for="exampleFormControlSelect1">Status Keluarga</label>
                                         <select class="form-control" id="exampleFormControlSelect1">
                                             <option>Anak</option>
                                             <option></option>
                                         </select>

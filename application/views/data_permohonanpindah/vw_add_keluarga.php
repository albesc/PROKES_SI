             ...
             <div class="header-body">
                 <div class="row align-items-center py-4">
                     <div class="col-lg-6 col-7">
                         <h3 class="h1 text-white d-inline-block mb-0">Tambah Data Keluarga Yang Pindah</h3>
                     </div>
                 </div>
             </div>
         </div>
             ...
             <div class="col">
                 <div class="card">
                     ...
                     <div class="card-header border-0">
                         <form action="<?= base_url('Permohonanpindah/upload_keluarga'); ?>" method="post" enctype="multipart/form-data">

                    ...
                    <form>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="form-control-label" for="input-email">Nomor Kartu Keluarga</label>
                                        <input type="email" id="input-email" class="form-control" placeholder="NKK" value="">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                        ...
                        <div class="pl-lg-4">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="input-username" class="form-control" placeholder="pekerjaan" value="">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="form-control-label" for="exampleFormControlSelect1">Jenis Kepindahan</label>
                                        <select class="form-control" id="exampleFormControlSelect1">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="form-control-label" for="exampleFormControlSelect1">Status KK Yang Tidak Pindah</label>
                                        <select class="form-control" id="exampleFormControlSelect1">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="form-control-label" for="exampleFormControlSelect1">Status KK Yang Pindah</label>
                                        <select class="form-control" id="exampleFormControlSelect1">
                                            <option>Numpang KK</option>
                                            <option>Membuat KK Baru</option>
                                            <option>Nomor KK Tetap</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-4 text-right">
                                    <a href="<?= site_url('pindahdomisili/add_keluarga'); ?>" class="btn btn-sm btn-primary">Tambah</a>
                                </div>
                            </div>
                            <!-- Light table -->

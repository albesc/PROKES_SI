                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <label class="form-control-label" for="input-username">Asep</label>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <label class="form-control-label" for="input-username">RS/RB</label>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <label class="form-control-label" for="input-username">Senin</label>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="example-date-input" class="form-control-label">Tanggal Kelahiran</label><br>
                                        <label class="form-control-label" for="input-username">23-08-2020</label>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="example-time-input" class="form-control-label">Pukul</label><br>
                                        <label class="form-control-label" for="input-username">15:00</label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <label class="form-control-label" for="input-username">Tunggal</label>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <label class="form-control-label" for="input-username">2.3 Kg</label>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group">
                                        <label for="example-date-input" class="form-control-label">Panjang Bayi</label><br>
                                        <label class="form-control-label" for="input-username">50 Cm</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <label class="form-control-label" for="input-username">02-02-1999</label>
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <label class="form-control-label" for="input-username">Melayu</label>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="example-date-input" class="form-control-label">Tanggal Pencatatan Perkawinan</label><br>
                                        <label class="form-control-label" for="input-username">07-07-2019</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="pl-lg-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="form-control-label" for="input-first-name">Kebangsaan</label><br>
                                        <label class="form-control-label" for="input-username">Minang</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <label class="form-control-label" for="input-username">Perempuan</label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
